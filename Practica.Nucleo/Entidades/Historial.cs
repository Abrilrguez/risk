...
namespace Practica.Nucleo.Entidades
{
    public class Historial : Persistent
    {
        ...
        ".mini-block {border: 1px solid #e5e5e5; border-radius: 5px;background-color: #ffffff;padding: 12px 15px 15px; text-align: left;width: 253px;}" +
        ".mini-container-left {width: 278px;padding: 10px 0 10px 15px;}" +
        ".mini-container-right {width: 278px; padding: 10px 14px 10px 15px;}" +
        ".product { text-align: left;vertical-align: top;width: 175px; }" +
        ".total-space { padding-bottom: 8px;display: inline-block;}" +
        ".item-table { padding: 50px 20px;width: 560px; }" +
        ".item {width: 300px;}" +
        ".mobile-hide-img {text-align: left;width: 125px;}" +
        ".mobile-hide-img img{border: 1px solid #e6e6e6; border-radius: 4px;}" +
        ".title-dark {text-align: left; border-bottom: 1px solid #cccccc; color: #4d4d4d; font-weight: 700; padding-bottom: 5px;}" +
        ".item-col {padding-top: 20px; text-align: left; vertical-align: top;}" +
        ".force-width-gmail { min-width:600px; height: 0px !important; line-height: 1px !important;font-size: 1px !important;}" +
        "</style>" +
        "<style type = 'text/css' media'screen'> url(http://fonts.googleapis.com/css?family=Oxygen:400,700);</style>" +
...
"                      <a href = '' >< img width='auto' height='47' src='https://i.ibb.co/g4TYX1x/logo.png' alt='logo'></a>" +
"                    </td>" +
"                  </tr>" +
"                </table>" +
"              </center>" +
